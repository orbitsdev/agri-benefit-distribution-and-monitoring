...
class SupportDistributionTransactionHistory extends Component implements HasForms, HasTable
{
    ...
    public function mount(Distribution $record){
        $this->record = $record;
    ...
    public function render()
    {
        ...
        return view('livewire.support-distribution-transaction-history');
    }
}
