...
class CreateDistributionSupport extends CreateRelatedRecord
{
    use NestedPage;
    ...
    protected function getRedirectUrl(): string
    {
        ...
        return route('filament.barangay.resources.distributions.supports',['record'=> $this->getRecord()->distribution_id]);
...
protected function handleRecordCreation(array $data): Model
{
   ...
   return $this->getRecord()->supports()->create($data);
}
}
