...
class TransactionHistory extends Page implements HasForms, HasTable
{
    ...
    protected static string $view = 'filament.resources.distribution-resource.pages.transaction-history';
    ...
    {
        return __($this->record->title . ' Transaction History');
    }
        ...
        return $table
            ...
            ->columns([
                ...
                ColumnGroup::make('Barangay Details', [
                    Tables\Columns\TextColumn::make('barangay_details.name')
                        ->searchable(query: function ($query, $search) {
                            return $query->whereJsonContains('barangay_details->name', $search);
                        })
                        ->label('Barangay')
                        ->toggleable(isToggledHiddenByDefault: false),

                    Tables\Columns\TextColumn::make('barangay_distribution_details.location')
                        ->searchable(query: function ($query, $search) {
                            return $query->whereJsonContains('barangay_distribution_details->location', $search);
                        })
                        ->label('Location')
                        ->toggleable(isToggledHiddenByDefault: true),
                ]),
