<div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0 bg-gray-100  relative"  style="background: url('{{ asset('images/bg2.png') }}') center/cover no-repeat;">
